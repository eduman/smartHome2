...
RESULT=("{\"configured\": true,\"ip\": \"$IP\",\"subnet\": \"$NETMASK\",\"gateway\": \"$GATEWAY\",\"description\": \"raspberry pi\",\"isError\": false,\"functions\": [{\"type\": \"SoC Temperature\",\"configuredAs\": \"Sensor\",\"rest\":\"GET\",\"ws\":\"/rest/raspberry/temperature\"}]}")
echo "$RESULT"
